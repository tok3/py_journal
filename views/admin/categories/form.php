	...
	<div class="content">
		...
		<div class="form_inputs">
			...
			<ul>
				...
				<li>
					<label for="status">Schema.org itemscope </label>
					<div class="input"><?php echo form_dropdown('itemscope', array('Article' => 'Article','NewsArticle' => 'NewsArticle','TechArticle' => 'TechArticle','ScholarlyArticle' => 'ScholarlyArticle', 'BlogPosting' => 'BlogPosting'), $category->itemscope) ?></div>
				</li>
			</ul>
