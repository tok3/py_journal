<fieldset id="filters">
	...
	<?php echo form_open('', '', array('f_module' => $module_details['slug'])) ?>
		<ul>
			<li class="">
        		<label for="f_status"><?php echo lang('journal:status_label') ?></label>
        		<?php echo form_dropdown('f_status', array(0 => lang('global:select-all'), 'draft'=>lang('journal:draft_label'), 'live'=>lang('journal:live_label'))) ?>
    		</li>

			<li class="">
        		<label for="f_category"><?php echo lang('journal:category_label') ?></label>
